...
const templates = {
  ...
  userRemoved: 'User with name "{{name}}" and id "{{_id}}" was removed',
  ...
  serviceRemoved: 'Service with name "{{name}}" and id "{{_id}}" was removed',
  ...
  servicePluginConfigRemoved: 'ServicePluginConfig with id "{{_id}}" of service "{{_service}}" was removed',

  socketAuth: 'User "{{user.name}}" authenticated in socket "{{id}}"',
  socketAuthError: 'Authentication error in socket "{{id}}"',
  socketAuthDisconnected: 'User "{{user.name}}" disconnected from socket "{{id}}"',
  socketConnected: 'Socket connection "{{id}}" open',
  socketDisconnected: 'Socket connection "{{id}}" closed'
}
