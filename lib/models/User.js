...
const Model = function (service) {
  ...
  const emailValidator = new utils.ValidateUniqueModel(models, 'User', 'email', templates.emailAlreadyExists())
  ...
  const schema = new Schema({
    name: {
      ...
      validate: {
        validator: new utils.ValidateUniqueModel(models, 'User', 'name'),
