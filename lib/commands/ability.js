...
const PUBLIC_FIELDS = 'name _service description event action state type format enum maxLength minLength pattern multipleOf minimum maximum exclusiveMaximum exclusiveMinimum updatedAt createdAt'
