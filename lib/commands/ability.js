...
const PUBLIC_FIELDS = 'name _service _user description event action state type format enum maxLength minLength pattern multipleOf minimum maximum exclusiveMaximum exclusiveMinimum updatedAt createdAt'
